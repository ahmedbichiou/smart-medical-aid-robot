...
Function refreshMenuMED;
  remplir(this.capsuleNumber,this.callback,this.refreshMenuMED, {Key? key}) : super(key: key);
  
 
  @override
  State<remplir> createState() => _remplir();
}

class _remplir extends State<remplir> {
